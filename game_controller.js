  ...
  var view = View.getInstance(),
    ...
    attemptMove = function(startPosition, endPosition){
      ...
      if( moveObject.illegal ){
        ...
        // capturable pieces are getting deleted on their team's turn
    ...
    tests = {
      ...
      complexStalemate: function(){
        // some sort of bug around the board here. board reference ends up wrong on instance of gameController, but behavior is correct during test
        // var = GameController.getInstance();
        var newBoard = new Board({ layOut: 
          [
